...
use MenAtWork\ClipboardBundle\Clipboard;
use MenAtWork\ClipboardBundle\Helper\Base as BaseHelper;
...
if (TL_MODE == 'BE' &&
     ...
     * Hooks
     */
    $GLOBALS['TL_HOOKS']['outputBackendTemplate'][]               = [
        Clipboard::class,
        'outputBackendTemplate'
    ];
    $GLOBALS['TL_HOOKS']['clipboardButtons'][]                    = [
        BaseHelper::class,
        'clipboardButtons'
    ];
    $GLOBALS['TL_HOOKS']['clipboardActSelectButtonsTreeView'][]   = array(
        BaseHelper::class,
        'clipboardActSelectButtons'
    );
    $GLOBALS['TL_HOOKS']['clipboardActSelectButtonsParentView'][] = array(
        BaseHelper::class,
        'clipboardActSelectButtons'
    );
